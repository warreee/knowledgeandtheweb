...
Apart from \emph{rule learning} we also experimented witch decision trees. First we applied the standard decision tree in RapidMiner, it created a to complicated decision tree, as you can see in figure 1.
\begin{figure}[H]
  \centering
