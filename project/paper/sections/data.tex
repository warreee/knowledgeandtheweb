...
% Training : scientist, economist, nobel prize winners (3 categorien) : willen een dataset die sterk op elkaar lijkt: nobelprijs winnaars en niet nobelprijs winnaars en waarvoor we gelijkaardige features kunnen gebruiken
% Research : european politicians van ToE 
